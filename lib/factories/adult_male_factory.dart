...
import '../data/suggested_tasks.dart';
import 'section_factory.dart';

class AdultMaleFactory implements SectionFactory {
  @override
  Widget buildHeader(BuildContext context, WidgetRef ref) {
    ...
    for (final prayer in data.prayerStatus.values) {
      ...
      // We count Fard as the main "item" for progress
      totalItems++; 
    }
        ...
        child: Row(
          ...
          children: [
            ...
            DailyProgressIndicator(
              ...
              points: totalHasanat,
              label: l10n.get('goodDeeds'), // Make sure to add this key or use literal for now
            ),
            Row(
              children: [
                IconButton(
      ...
      child: Column(
        children: [
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              buildPrayerCard('fajr', '🌅', Colors.orange),
              const SizedBox(width: 8),
              buildPrayerCard('duha', '☀️', Colors.amber),
              const SizedBox(width: 8),
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              buildPrayerCard('maghrib', '🌅', Colors.deepOrange),
              const SizedBox(width: 8),
              buildPrayerCard('isha', '🌙', Colors.indigo),
              const SizedBox(width: 8),
              buildPrayerCard('witr', '🌌', Colors.deepPurple),
        ...
        children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: data.knowledgeCompleted ? Colors.blue : Colors.grey.shade200,
                borderRadius: BorderRadius.circular(12),
              ),
              child: Icon(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
                      ...
                      onPressed: () {
                        showModalBottomSheet(
                          ...
                          builder: (context) => ListView(
                            ...
                            children: SuggestedTasks.maleTasks.map((task) => ListTile(
                              title: Text(task),
                              onTap: () {
              ...
              InkWell(
                ...
                child: Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: data.mainTaskCompleted ? Colors.teal : Colors.grey.shade200,
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Icon(
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: SuggestedTasks.maleTasks.take(6).map((task) {
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: data.mainTask == task ? Colors.teal : Colors.teal.shade50,
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                      color: data.mainTask == task ? Colors.teal : Colors.teal.shade200,
                      width: 1.5,
                    ),
                  ),
                  child: Text(
        ...
        children: List.generate(8, (index) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: filled ? Colors.blue : Colors.blue.withValues(alpha: 0.1),
